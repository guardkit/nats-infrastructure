...
self = <test_volume_persistence.TestVolumePersistenceIntegration object at 0xf1224965bf20>
...
E             
E           assert 1 == 0
E            +  where 1 = CompletedProcess(args="nats -s nats://localhost:4222 pub persistence.test 'test-message-0'", returncode=1, stdout='', stderr='nats: error: nats: Authorization Violation\n').returncode
...
self = <test_volume_persistence.TestVolumePersistenceIntegration object at 0xf1224965bad0>
...
E         
E       assert 1 == 0
E        +  where 1 = CompletedProcess(args='nats -s nats://localhost:4222 stream info SURVIVAL_TEST --json', returncode=1, stdout='', stderr='nats: error: setup failed: nats: Authorization Violation\n').returncode
...
self = <test_volume_persistence.TestVolumePersistenceIntegration object at 0xf1224965b500>
...
E         
E       assert 1 == 0
E        +  where 1 = CompletedProcess(args='nats -s nats://localhost:4222 stream info RETRIEVAL_TEST --json', returncode=1, stdout='', stderr='nats: error: setup failed: nats: Authorization Violation\n').returncode
